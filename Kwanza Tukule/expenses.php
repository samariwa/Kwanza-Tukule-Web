  ...
  <div class="row">
    <div class="col-md-4">
      <a data-toggle="modal" data-target="#exampleModalScrollable" class="btn btn-success btn-md active" role="button" aria-pressed="true">
        <i class="fa fa-plus-circle"></i>&ensp;Add Expense
      </a>
      <!-- Modal -->
                          ...
                          <table id="expensesEditable" class="table table-striped table-hover paginate" style="display:block;overflow-y:scroll;text-align: center;">
                            ...
                            <tbody >
                              ...
                              <tr>
                                ...
                                <td class="editable" id="particular
                                  <?php echo $count; ?>">
                                  <?php echo $particular; ?>
                                </td>
                                <td class="editable" id="party
                                  <?php echo $count; ?>">
                                  <?php echo $party; ?>
                                </td>
                                <td class="editable" id="total
                                  <?php echo $count; ?>">
                                  <?php echo $total; ?>
                                </td>
                                <td class="editable" id="paid
                                  <?php echo $count; ?>">
                                  <?php echo $paid; ?>
                                </td>
                                <td class="uneditable" id="due
                                  <?php echo $count; ?>">
                                  <?php echo $due; ?>
                                </td>
                                <td class="editable" id="date
                                  <?php echo $count; ?>">
                                  <?php echo $date; ?>
                                </td>
                                <td>
                                  <button id="
                                    <?php echo $id; ?>" data_id="
                                    <?php echo $id; ?>" class="btn btn-danger btn-sm active deleteExpense" role="button" aria-pressed="true" >
