<?php
 ...
 ?> 
  ...
  <div class="row">
             <a data-toggle="modal" data-target="#exampleModalScrollable" class="btn btn-success btn-md active" role="button" aria-pressed="true" style="margin-left: 20px;"><i class="fa fa-plus-circle"></i>&ensp;Add Expense</a>
       <!-- Modal -->
      ...
      ?>
      <h6 style="margin-left: 270px;">Total Number: <?php echo $expensesrowcount; ?></h6>
       <a href="expense_heading.php" class="btn btn-primary btn-md active" role="button" aria-pressed="true" style="margin-left: 310px;">Expense Heading</a>
        </div><br>
