 ...
 ?> 
  <!-- Page Heading -->
      ...
      <a href="sales.php" class="btn btn-primary btn-md active" role="button" aria-pressed="true" style="margin-left: 30px;"><i class="fa fa-arrow-left"></i>&ensp;Back</a>
        ...
        <h6 style="margin-left: 50px;margin-right: 50px;">To print tomorrow's distribution list, enter deliverer's name and click the 'Print button'. Otherwise include point in time from which the distribution list should be printed.</h6><br>
        ...
        <div class="row">
         ...
         <input type="text" class="form-control col-md-5" aria-label="Default" aria-describedby="inputGroup-sizing-default" style="font-family: FontAwesome, Arial; font-style: normal;"  name="time" id="distributionTime">
       </div>
        </div><br>

        <div class="row">
           <button class="btn btn-light btn-md active printDistribution" role="button" aria-pressed="true" style="margin-left: 450px;"><i class="fa fa-print"></i>&ensp;Print</button>
        </div><br><br>
