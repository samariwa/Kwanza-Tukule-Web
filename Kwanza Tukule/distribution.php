...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Dashboard 
      ...
      <span style="font-size: 15px;"> /Goods Distribution</span>
    </h1>
    ...
    <br>
      <div class="row">
        <div class="col-md-10 offset-1">
          <h6 class="col-md-10 offset-1">To print tomorrow's distribution list, enter deliverer's name and click the 'Print button'. Otherwise include point in time from which the distribution list should be printed.</h6>
          <br>
          </div>
        </div>
        <div class="row">
              ...
              <br>
                <div class="row">
                  <div class="col-md-2 offset-5">
                    <button class="btn btn-light btn-md active printDistribution" role="button" aria-pressed="true">
