...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <h6 style="margin-left: 550px;">Time: 
      <span id="time"></span>
    </h6>
    <form method="post">
      <a  name="create_pdf" href="reportPDF.php" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm mr-2">
        <i class="fa fa-download fa-sm text-white-50"></i> Export Report
      </a>
    </form>
  </div>
  <?php
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Dashboard</h1>
    <h6 style="margin-right: 20px;">Time: 
      <span id="time"></span>
    </h6>
  </div>
  <?php
...
<div class="col-lg-6 mb-4">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <h4 class="small font-weight-bold">Processing orders 
      ...
      <h4 class="small font-weight-bold">Inspecting work area 
        <span class="float-right">60%</span>
      </h4>
      <div class="progress mb-4">
        <div class="progress-bar" role="progressbar" style="width: 60%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
      </div>
      <h4 class="small font-weight-bold">Debriefing staff 
        <span class="float-right">80%</span>
      </h4>
      <div class="progress mb-4">
        <div class="progress-bar bg-info" role="progressbar" style="width: 80%" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
      </div>
      <h4 class="small font-weight-bold">Order Inventory 
