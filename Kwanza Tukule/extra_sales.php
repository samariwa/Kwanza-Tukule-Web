<?php
 ...
 ?>
    ...
    <div class="col-md-3">
      <a href="goods_requisition.php" class="btn btn-success btn-md active offset-2" role="button" aria-pressed="true"><i class="fa fa-plus-circle"></i>&ensp;Goods Requisition</a>
    </div>
    </div><br>
