      ...
      if ($exists > 0){
        ...
        $mail -> Body = "
              Hi $name;<br><br>
                ...
                <a href='
                http://mariwa.ddns.net/Kwanza%20Tukule%20Web/Kwanza%20Tukule/resetPassword?email=$email&token=$random'>http://mariwa.ddns.net/Kwanza%20Tukule%20Web/Kwanza%20Tukule/resetPassword?email=$email&token=$random</a><br><br>
...
<html>
  <head>
    <meta charset="utf-8">
      <title>Kwanza Tukule | Forgot Password</title>
                  ...
                  <nav style="background-color: white;opacity: 0.9">
                    <div class="logo">&emsp;&emsp;
                      ...
                      <a class="navbar-brand" href="#">
                        <img src="../Kwanza Tukule/assets/img/Kwanza Tukule.png" height="55" width="140">
                        </a>
                      </div>
                    </nav>
                              ...
                              <div class="card" style="opacity: 0.8">
                                <br>
                                  <h4 style="text-align: center;">
                                    <i class="fa fa-key"></i>&ensp;Forgot Password
                                  </h4>
                                  <div class="card-body">
                                    <form method="POST" >
                                      <br>
                                        ...
                                        <p style="text-align: center;font-size: 15px;">
                                          <i>(This site is restricted to public access.)</i>
                                        </p>
                                          ...
                                          <div class="form-group row" >
                                            ...
                                            <div class="form-group row mb-0">
                                              ...
                                              <br>
                                                <br>&emsp;&emsp;&emsp;
                                                  <font color="green">
                                                    <i class="bx bx-check-circle bx-flashing"></i>&ensp;Please check your email for verification code.
                                                    <br> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                                                      <i class="bx bxs-hourglass-bottom bx-flashing"></i>&ensp;The code expires in 5 minutes.
                                                    </font>'; ?>
                                                    ...
                                                    <br>
                                                      <br>&emsp;&emsp;
                                                        <font color="red">
                                                          <i class="bx bx-error-alt bx-flashing"></i>&ensp;Oops! Something went wrong. Please try again.
                                                        </font>'; ?>
                                                        <?php if ($exists == FALSE)
                                                        echo '
                                                        <br>
                                                          <br>&emsp;&emsp;
                                                            <font color="red">
                                                              <i class="bx bx-error-alt bx-flashing"></i>&ensp;Please ensure that the email address entered was 
                                                              <br>&emsp;&emsp;&emsp;&ensp;used in registration.
                                                              </font>'; ?>
                                                              <br>
                                                                <br>
                                                                  <div class="col-md-8 offset-md-4">
