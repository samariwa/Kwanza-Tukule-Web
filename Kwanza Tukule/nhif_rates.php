...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Dashboard 
      ...
      <span style="font-size: 12px;"> /NHIF Rates</span>
    </h1>
    ...
    <br>
      <div class="row">
        <div class="col-md-10 offset-1">
          <p>They above is the payment criteria for employed members only. Self-employed/voluntary members pay Ksh. 500 per month. For more information or queries, 
            <a href="http://www.nhif.or.ke/healthinsurance/">Visit NHIF Page 
