                                ...
                                <div class="card" style="opacity: 0.8">
                                  <br>
                                    <h4 style="text-align: center;">
                                      <i class="fa fa-fingerprint"></i>&ensp;Reset Password
                                    </h4>
                                    <div class="card-body">
                                      <form method="POST" >
                                        <br>
                                          <div class="form-group row" >
                                            ...
                                            <div class="col-md-6 ">
                                              <input id="pass" type="password"  name="pass" value="" required autocomplete="current-password"  class="
                                            ...
                                            <br>
                                              <br>
                                                <div class="form-group row" >
                                                  ...
                                                  <div class="col-md-6 ">
                                                    <input id="pass2" type="password"  name="pass2" required autocomplete="current-password" class=" 
                                                      <?php if ($validationresults == FALSE)
                                                       echo "invalid"; ?>">
                                                    </div>
                                                  </div>
                                                  <br>
                                                    <div class="form-group row mb-0">
                                                      ...
                                                      <br>
                                                        <br>&emsp;&emsp;
                                                          <font color="red">
                                                            <i class="bx bxs-lock bx-flashing"></i>&ensp;
                                                            <font color="red">
                                                              <i class="bx bxs-error bx-flashing"></i>&ensp;Your passwords do not match.
                                                            </font>'; ?>
                                                            ...
                                                            <br>
                                                              <br>&emsp;&emsp;
                                                                <font color="red">
                                                                  <i class="bx bx-shield-quarter bx-flashing"></i>&ensp;Your password should be greater than 8 characters.
                                                                </font>'; ?>
                                                                <br>
                                                                </form>
                                                              </div>
