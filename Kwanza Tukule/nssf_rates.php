...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Dashboard 
      ...
      <span style="font-size: 15px;"> /Employee Payroll</span>
      <span style="font-size: 12px;"> /NSSF Rates</span>
    </h1>
  ...
  <div class="row">
    <div class="col-md-2">
      <a href="payroll.php" class="btn btn-primary btn-md active float-left ml-3" role="button" aria-pressed="true">
    ...
    <br>
      <div class="row">
        <div class="col-md-10 offset-1">
          <p>According to the new NSSF Act, employer will contribute 50% and employee will contribute the other 50% of the total contribution expected based on the income of employee. For more information or queries, 
            <a href="https://www.nssf.or.ke/downloads">Visit NSSF Page 
