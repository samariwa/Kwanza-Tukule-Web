<?php
 ...
 ?> 
  ...
  <div class="row">
    <div class="col-md-4">
             <a data-toggle="modal" data-target="#exampleModalScrollable" class="btn btn-success btn-md active" role="button" aria-pressed="true" ><i class="fa fa-plus-circle"></i>&ensp;New Office Staff</a>
       <!-- Modal -->
      ...
      ?>
      <h6 class="offset-2">Total Number: <?php echo $officerowcount; ?></h6>
        </div>
      </div><br>
