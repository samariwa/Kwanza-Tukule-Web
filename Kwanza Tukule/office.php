...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Dashboard 
      <span style="font-size: 18px;">/Staff</span>
      <span style="font-size: 15px;"> /Office</span>
    </h1>
  ...
  <div class="row">
    <div class="col-md-2">
      <a data-toggle="modal" data-target="#exampleModalScrollable" class="btn btn-success btn-md active" role="button" aria-pressed="true" >
        <i class="fa fa-plus-circle"></i>&ensp;New Office Staff
      </a>
      <!-- Modal -->
                              ...
                              <br>
                                <div class="row">
                                  ...
                                  <div class="col-md-2">
                                    ...
                                    ?>
                                    <h6 class="offset-1">Total Number: 
                                      <?php echo $officerowcount; ?>
                                    </h6>
                                  </div>
                                  <div class="col-md-2">
                                ...
                                <br>
                                  <table id="officeEditable" class="table table-striped table-hover paginate" style="display:block;overflow-y:scroll;text-align: center;">
                                    ...
                                    <tbody >
                                      ...
                                      <tr>
                                        ...
                                        <td class="editable" id="contact
                                          <?php echo $count; ?>">
                                          <?php echo $contact; ?>
                                        </td>
                                        <td class="uneditable" id="gender
                                          <?php echo $count; ?>">
                                          <?php echo $gender; ?>
                                        </td>
                                        <td class="editable" id="role
                                          <?php echo $count; ?>">
                                          <?php echo $role; ?>
                                        </td>
                                        <td class="editable" id="staffId
                                          <?php echo $count; ?>">
                                          <?php echo $staffId; ?>
                                        </td>
                                        <td class="editable" id="nationalId
                                          <?php echo $count; ?>">
                                          <?php echo $nationalId; ?>
                                        </td>
                                        <td class="uneditable" id="age
                                          <?php echo $count; ?>">
                                          <?php echo $age; ?>
                                        </td>
                                        <td class="editable" id="salary
                                          <?php echo $count; ?>">Ksh. 
                                          <?php echo $salary; ?>
                                        </td>
                                        <td class="editable" id="kra
                                          <?php echo $count; ?>">
                                          <?php echo $kra; ?>
                                        </td>
                                        <td class="editable" id="nssf
                                          <?php echo $count; ?>">
                                          <?php echo $nssf; ?>
                                        </td>
                                        <td class="editable" id="nhif
                                          <?php echo $count; ?>">
                                          <?php echo $nhif; ?>
                                        </td>
                                        <td>
                                          <button id="
                                            <?php echo $id; ?>" data_id="
                                            <?php echo $id; ?>" class="btn btn-danger btn-sm active deleteOffice" role="button" aria-pressed="true" >
