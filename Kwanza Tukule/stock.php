...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-md-2">
      <a data-toggle="modal" data-target="#exampleModalScrollable" class="btn btn-success btn-md active" role="button" aria-pressed="true" >
        <i class="fa fa-plus-circle"></i>&ensp;New Stock
      </a>
      <!-- Modal -->
                              ...
                              <br>
                                ...
                                <br>
                                  ...
                                  <br>
                                    ...
                                    ?>
                                    <div class="offset-2">
                                      <h6 class="offset-4">Total Number: 
                                        <?php echo $stockrowcount; ?>
                                      </h6>
                                    </div>
                                      ...
                                      <tbody >
                                        ...
                                        ?>
                                         ...
                                         if ($view == 'Software' || $view == 'General Operations Manager' || $view == 'CEO') {
                                          ...
                                          <td class="editable" id="name
                                            <?php echo $count; ?>">
                                            <?php echo $name; ?>
                                          </td>
                                          <td class="editable" id="bp
                                            <?php echo $count; ?>">
                                            <?php echo $buying_price; ?>
                                          </td>
                                          <td class="editable" id="sp
                                            <?php echo $count; ?>">
                                            <?php echo $selling_price; ?>
                                          </td>
                                          <td class="uneditable" id="qty
                                            <?php echo $count; ?>">
                                            <?php echo $quantity; ?>
                                          </td>
                                          <?php
                                          ...
                                          <?php
                                           ...
                                           if ($view == 'Software' || $view == 'General Operations Manager' || $view == 'CEO') {
                                          ?>
                                          <td class="editable" id="restock_Level
                                            <?php echo $count; ?>">
                                            <?php echo $restock_Level; ?>
                                          </td>
                                          <td>
                                            <button data-toggle="modal" data-target="#exampleModalScrollable
                                              <?php echo $id; ?>" id="
                                              <?php echo $id; ?>" data_id="
                                              <?php echo $id; ?>" class="btn btn-light btn-sm active restock" role="button" aria-pressed="true" >
                                              <i class="fa fa-plus"></i>&ensp;Restock
                                            </button>
                                            <div class="modal fade" id="exampleModalScrollable
                                              <?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
                                              <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                  <div class="modal-header">
                                                    ...
                                                    <form method="POST">
                                                      <div class="row">
                                                        ...
                                                        <input type="date" name="received" id="received
                                                          <?php echo $id; ?>" class="form-control col-md-9" style="padding:15px;margin-left: 60px" placeholder="Date Received..." required>
                                                        </div>
                                                        <br>
                                                          <div class="row">
                                                            <input type="number" name="qty" id="qty
                                                              <?php echo $id; ?>" class="form-control col-md-9" style="padding:15px;margin-left: 60px" placeholder="Quantity Purchased..." required min="1" oninput="validity.valid||(value='');">
                                                            </div>
                                                            <br>
                                                              <div class="row">
                                                                <input type="number" name="bp" id="bp
                                                                  <?php echo $id; ?>" class="form-control col-md-9" style="padding:15px;margin-left: 60px" placeholder="Buying Price..." required min="0.01" step="0.01" oninput="validity.valid||(value='');">
                                                                </div>
                                                                <br>
                                                                  <div class="row">
                                                                    <input type="number" name="sp" id="sp
                                                                      <?php echo $id; ?>" class="form-control col-md-9" style="padding:15px;margin-left: 60px" placeholder="Selling Price..." required min="0.01" step="0.01" oninput="validity.valid||(value='');">
                                                                    </div>
                                                                    <br>
                                                                      <div class="row">
                                                                        <label for="expiry" style="margin-left: 60px;">Expiration Date:</label>
                                                                        <input type="date" name="expiry" id="expiry
                                                                          <?php echo $id; ?>" class="form-control col-md-9" style="padding:15px;margin-left: 60px" placeholder="Expiry Date..." required>
                                                                        </div>
                                                                      </div>
                                                                      <div class="modal-footer">
                                                                        <button type="submit" class="btn btn-primary addPurchase" style="margin-right: 50px" id="
                                                                          <?php echo $id; ?>">Add Purchase
                                                                        </button>
                                                                      </form>
                                                                    </div>
                                                                  </div>
                                                            ...
                                                            <button id="
                                                              <?php echo $id; ?>" data_id="
                                                              <?php echo $id; ?>" class="btn btn-danger btn-sm active deleteStock" role="button" aria-pressed="true" >
