...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Dashboard 
      <span style="font-size: 18px;">/NoteBook</span>
    </h1>
  ...
  <br>
    <div class="row">
      <div class="col-md-2 offset-10">
        <button data-toggle="modal" data-target="#exampleModalScrollable" type="button" class="btn btn-success">
          <i class="fa fa-plus"></i>&ensp;Place Note
        </button>
                ...
                <hr>
                  ...
                  <hr>
                    ...
                    <div class="card mb-3" id = "card
                      <?php echo $id ?>" style="max-width: 50rem;margin-left: 200px;">
                      ...
                      <div class="card-body">
                        ...
                        <button data-toggle="modal" data-target="#exampleModalScrollable2" id="
                          <?php echo $id; ?>" data_id="
                          <?php echo $id; ?>" class="btn btn-primary" role="button" aria-pressed="true" >
                        ...
                        <div class="modal fade" id="exampleModalScrollable2" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
                                ...
                                <form method="POST">
                                  <div class="row">
                                    <input type="text" name="title" id="title
                                      <?php echo $id; ?>" class="form-control col-md-9" style="padding:15px;margin-left: 60px" value="
                                      <?php echo $title ?>" required>
                                    </div>
                                    <br>
                                      <textarea type="text" name="body" id="body
                                        <?php echo $id; ?>" class="form-control col-md-9" style="padding:15px;margin-left: 60px"  required>
                                        <?php echo $note ?>
                                      </textarea>
                                    </div>
                                    <div class="modal-footer">
                                      <button type="submit" class="btn btn-primary editPublicNote" style="margin-right: 50px" id="
                                        <?php echo $id; ?>">Done
                                      </button>
                                    </form>
                                  </div>
                            ...
                            <button id="
                              <?php echo $id; ?>" data_id="
                              <?php echo $id; ?>" class="btn btn-danger deletePublicNote" role="button" aria-pressed="true" style="margin-left: 580px">
                            ...
                            <hr>
                              ...
                              <div class="card text-white bg-secondary mb-3" style="max-width: 50rem;">
                                ...
                                <div class="card-body">
                                  ...
                                  <button data-toggle="modal" data-target="#exampleModalScrollable3" id="
                                    <?php echo $id; ?>" data_id="
                                    <?php echo $id; ?>" class="btn btn-primary" role="button" aria-pressed="true" >
                                    <i class="fa fa-edit"></i>&ensp;Edit
                                  </button>
                                  <div class="modal fade" id="exampleModalScrollable3" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
                                        ...
                                        <div class="modal-body">
                                          <form method="POST">
                                            <div class="row">
                                              ...
                                              <div class="modal-footer">
                                                <button type="submit" class="btn btn-primary editPrivateNote" style="margin-right: 50px" id="
                                                  <?php echo $id; ?>">Done
                                                </button>
                                              </form>
                                            </div>
                                      ...
                                      <button id="
                                        <?php echo $id; ?>" data_id="
                                        <?php echo $id; ?>" class="btn btn-danger deletePrivateNote" role="button" aria-pressed="true" style="margin-left: 580px">
                                        <i class="fa fa-trash"></i>&ensp;Delete
                                      </button>
                                    </div>
                                  </div>
