...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-warning shadow h-100 py-2">
        <a class="text-xs font-weight-bold text-warning text-uppercase mb-1" href="#" style="text-decoration: none;">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
  ...
  <br>
    ...
    <br>
      <div class="row" style="margin-left: 50px;">
        <h6>Total Sales Value: Ksh. 
          <?php echo $totalSalesYesterday; ?>
        </h6>
      </div>
      <br>
        <div class="row" style="margin-left: 50px;">
          <h6>Revenue Realized: Ksh. 
            <?php echo $totalRevenueYesterday; ?>
          </h6>
        </div>
        <br>
          <div class="row" style="margin-left: 50px;">
            <h6>Total Paid via M-Pesa for Yesterday's Sales: Ksh. 
              <?php echo $totalMpesaYesterday; ?>
            </h6>
          </div>
          <br>
            <div class="row" style="margin-left: 50px;">
              <h6>Total Paid in Cash for Yesterday's Sales: Ksh. 
                <?php echo $totalCashYesterday; ?>
              </h6>
            </div>
            <br>
              <div class="row" style="margin-left: 50px;">
                <h6>Total Debt Paid via M-Pesa: Ksh. 
                  <?php echo $totalMpesaDebt; ?>
                </h6>
              </div>
              <br>
                <div class="row" style="margin-left: 50px;">
                  <h6>Total Debt Paid in Cash: Ksh. 
                    <?php echo $totalCashDebt; ?>
                  </h6>
                </div>
                <br>
                  <div class="row" style="margin-left: 50px;">
                    <h6>Total Banked: Ksh. 
                      <?php echo $totalBankedYesterday; ?>
                    </h6>
                  </div>
                  <br>
                    <div class="row" style="margin-left: 50px;">
                      <h6>Expenditure: Ksh. 
                        <?php echo $expenditureYesterday; ?>
                      </h6>
                    </div>
                    <br>
