                                    ...
                                    <hr class="sidebar-divider my-0" style="border-color: black;">
                                      ...
                                      <li class="nav-item active">
                                        <a class="nav-link" href="dashboard.php" style="color: black;">
                                          ...
                                          ?>
                                          <span style="margin-left: 50px">Administrator</span>
                                        </a>
                                        <?php
                                        }
                                        else if ($view == 'Software'){
                                        ?>
                                        <span style="margin-left: 30px">Software Developer</span>
                                      </a>
                                      <?php
                                      }
                                      else if ($view == 'General Operations Manager'){
                                      ?>
                                      <span style="margin-left: 5px">General Operations Manager</span>
                                    </a>
                                    <?php
                                    }
                                    else if ($view == 'CEO'){
                                    ?>
                                    <span style="margin-left: 20px">Chief Executive Officer</span>
                                  </a>
                                  <?php
                                  }
                                  ?>
                                      ...
                                      <br>
                                        ...
                                        <br>
                                          ...
                                          <br>
                                            <!--       
                                              <li class="nav-item">&emsp;
                                              <a style="color: black;" href="#"><i class="fa fa-fw fa-table"></i><span>Targets</span></a></li><br><li class="nav-item">&emsp;
                                              <a style="color: black;" href="#"><span>Projects</span></a></li><br><li class="nav-item">&emsp;
                                              <a style="color: black;" href="#"><i class="fa fa-flag-checkered"></i><span>Milestones</span></a></li><br>
                                                            ...
                                                            <li class="nav-item dropdown open" >
                                                              ...
                                                              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                                <a class="dropdown-item" href="profile.php">
                                                                  <i class="fa fa-user"></i>&ensp;Profile
                    
                    
                                                                </a>
                                                                <div class="dropdown-divider"></div>
                                                                <a class="dropdown-item" href="logout.php">
                                                                  <i class="fa fa-sign-out"></i>&ensp;Logout
