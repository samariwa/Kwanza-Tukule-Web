  ...
  <!-- Page Heading -->
     ...
     <div class="row">
      ...
      <div class="input-group-prepend" style="margin-left: 350px;" >
       ...
       <div class="col-md-5">
       <input type="date"  class="form-control col-md-6" name="creditDate" id="creditDate" value="" aria-describedby="inputGroup-sizing-default" required autocomplete="date" autofocus style="font-family: FontAwesome, Arial; font-style: normal;">
        </div>
        </div><br>
         <?php
          }else{
      ...
      <div class="input-group-prepend" style="margin-left: 350px;" >
       ...
       <div class="col-md-5">
       <input type="date"  class="form-control col-md-6" name="creditDate" id="creditDate" value="" aria-describedby="inputGroup-sizing-default" disabled="true" autofocus style="font-family: FontAwesome, Arial; font-style: normal;">
        </div>
        </div><br>
        <?php
          }
