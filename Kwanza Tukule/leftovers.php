...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Dashboard 
      ...
      <span style="font-size: 15px;"> /Leftover Cereals</span>
    </h1>
 ...
 ?>
  ...
  <div class="row">
    <div class="col-md-2">
      <a href="stock.php" class="btn btn-primary btn-md active float-left" role="button" aria-pressed="true">
  ...
  <br>
    <table id="leftoversEditable" class="table table-striped table-hover paginate" style="display:block;overflow-y:scroll;text-align: center;">
      ...
      <tbody >
        ...
        ?>
        <tr>
          <th class="uneditable" scope="row"  id="id
            <?php echo $count; ?>">
            <?php echo $id; ?>
          </th>
          ...
          <td class="uneditable" id="ordered
            <?php echo $count; ?>">
            <?php echo $ordered; ?>
          </td>
          <td class="uneditable"id="prepared
            <?php echo $count; ?>">
            <?php echo $prepared; ?>
          </td>
          <td class="uneditable"id="returned
            <?php echo $count; ?>">
            <?php echo $returned; ?>
          </td>
          <td  class="editable" id="difference
            <?php echo $count; ?>">
            <?php echo $difference; ?>
          </td>
          <td  class="uneditable" id="leftover
            <?php echo $count; ?>">
            <?php echo $leftover; ?>
          </td>
          <td  class="uneditable" id="value
            <?php echo $count; ?>">
            <?php echo $value; ?>
          </td>
        </tr>
