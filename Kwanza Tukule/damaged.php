...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Dashboard 
      ...
      <span style="font-size: 15px;"> /Damaged Stock</span>
    </h1>
  ...
  ?>
  <div class="row">
    <a href="stock.php" class="btn btn-primary btn-md active float-left ml-3" role="button" aria-pressed="true">
    ...
    <table id="damagedEditable" class="table table-striped table-hover paginate" style="display:block;overflow-y:scroll;text-align: center;">
      ...
      <tbody >
        ...
        <tr>
          ...
          <td class="uneditable" id="purchased
            <?php echo $count; ?>">
            <?php echo $purchased; ?>
          </td>
          <td class="uneditable"id="undamaged
            <?php echo $count; ?>">
            <?php echo $Quantity; ?>
          </td>
          <td  class="editable" id="newDamaged
            <?php echo $count; ?>">0
          </td>
          <td  class="uneditable" id="damaged
            <?php echo $count; ?>">
            <?php echo $damaged; ?>
          </td>
