...
<div class="container-fluid">
  ...
  <br>
    ...
    <h6>
      ...
      <i>
        <b>Engage with a support specialist</b>
      </i>
    </h6>
    <p>Get quick help with your queries / recommendations via messaging support that operates 24/7.</p>
    <div class="row">
      <button data-toggle="modal" data-target="#exampleModalScrollable" class="btn btn-light btn-md active ml-3" role="button" aria-pressed="true" >
        <i class="fa fa-comment"></i>&ensp;Message Now
      </button>
      <!-- Modal -->
                ...
                <div class="modal-footer">
                  <button type="submit" class="btn btn-primary" style="margin-right: 50px" name="sendQuery">Send</button>
                      ...
                      <?php
                        ...
                        <br>
                          <br>
                                  One of the software users has a query / recommedation for you. Please help them out ASAP.
                            <br>
                              <br> 
                                  Message: $query
                      ...
                      ?>
                          ...
                          <br>
                            ...
                            <br>
                              <h6>
                                <i class="bx bxs-smile"></i>&ensp;
                                <b>We're happy to help</b>
                              </h6>
                              <?php
                             if (fsockopen('mariwa.ddns.net', 10080)){
                              ?>
                              <h6 style="text-align: right;">Server Status:&ensp;
                                <img src='assets/img/online.png' height='10' width='10' style='margin-top:0px;'>&ensp; Up
                                </h6>
                                <?php
                                } else{
                                ?>
                                <h6 style="text-align: right;">Server Status:&ensp;
                                  <img src='assets/img/offline.png' height='10' width='10' style='margin-top:0px;'>&emsp; Down
                                  </h6>
                                  <?php
                                   }
                                  ?>
