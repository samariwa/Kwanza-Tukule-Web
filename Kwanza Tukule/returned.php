...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Dashboard 
      ...
      <span style="font-size: 15px;">/Returned Goods</span>
    </h1>
 ...
 ?>
  ...
  <div class="row">
    <div class="col-md-4">
      <a href="sales.php" class="btn btn-primary btn-md active" role="button" aria-pressed="true">
  ...
  <br>
    ...
    <div class="row">
      ...
      ?>
        <h6 class="offset-2">Total Number: 
          <?php echo $extrareturnedrowcount; ?>
        </h6>
      </div>
    </div>
    <div class="row">
