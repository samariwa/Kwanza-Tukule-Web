...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Dashboard 
      ...
      <span style="font-size: 15px;"> /Employee Leave</span>
    </h1>
  ...
  <div class="row">
    <div class="col-md-6">
      <a href="sales.php" class="btn btn-primary btn-md active float-left ml-2" role="button" aria-pressed="true">
        <i class="fa fa-arrow-left"></i>&ensp;Back
      </a>
    </div>
    <div class="col-md-6">
      <a data-toggle="modal" data-target="#exampleModalScrollable" class="btn btn-success btn-md active float-left offset-7" role="button" aria-pressed="true">
        <i class="fa fa-plus-circle"></i>&ensp;Leave Application
      </a>
      <!-- Modal -->
      <div class="modal fade" id="exampleModalScrollable" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <br>
              <div class="row">
                <h6 class="col-md-8 offset-2">Employee leave data for the past month. The maximum leave days annually is 21 days.</h6>
                <br>
                </div>
                <div class="row">
                  <div class="col-md-8">
                    ...
                    ?>
                    <h6 class="offset-8">Total Number: 
                      <?php echo $leaverowcount; ?>
                    </h6>
                  </div>
                </div>
                <table id="leaveEditable" class="table table-striped table-hover paginate" style="display:block;overflow-y:scroll;text-align: center;">
                  ...
                  <tbody >
                    ...
                    <tr>
                      ...
                      <td class="uneditable"id="contact
                        <?php echo $count; ?>">
                        <?php echo $contact ?>
                      </td>
                      <td class="uneditable" id="department
                        <?php echo $count; ?>">
                        <?php echo $department ?>
                      </td>
                      <td class="uneditable" id="left
                        <?php echo $count; ?>">
                        <?php echo $left ?>
                      </td>
                      <td class="editable" id="start
                        <?php echo $count; ?>">
                        <?php echo $start ?>
                      </td>
                      <td class="editable" id="days
                        <?php echo $count; ?>">
                        <?php echo $days ?>
                      </td>
                      <td class="uneditable" id="end
                        <?php echo $count; ?>">
                        <?php echo $end ?>
                      </td>
                      <td class="editable" id="standIn
                        <?php echo $count; ?>">
                        <?php echo $replacement1 .' '. $replacement2; ?>
                      </td>
                    </tr>
                    <?php
                    }
