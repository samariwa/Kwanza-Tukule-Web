    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-xlg-3 col-md-5">
        <div class="card">
          <div class="card-body">
            <center class="m-t-30">
              <img src="assets/img/avatar.jpg" class="rounded-circle" width="150" />
              ...
              <br>
                <h6 class="card-subtitle" >Staff ID: 
                  <span id="staffid">
                    <?php echo $staffid; ?>
                  </span>
                </h6>
                <br>
                  <h6 class="card-subtitle">Age: 
                    <?php echo $age; ?>
                  </h6>
                  <br>
                    <h6 class="card-subtitle">Gender: 
                      <?php echo $gender; ?>
                    </h6>
                  </center>
                </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-12">
                        <input type="text" value="
                          <?php echo $user; ?>" class="form-control form-control-line" name="username" id="username" required>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-12">
                          <input type="email" value="
                            <?php echo $email; ?>" class="form-control form-control-line" name="email" id="email" required>
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <div class="col-md-12">
                            <input type="text" value="
                              <?php echo $number; ?>" class="form-control form-control-line" name="number" id="number" required>
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="col-md-12">
                              <input type="text" value="
                                <?php echo $nationalid; ?>" class="form-control form-control-line" name="nationalid" id="nationalid" required>
                              </div>
                            </div>
                            <br>
                              <div class="form-group">
