...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Dashboard 
      ...
      <span style="font-size: 12px;">/Goods Requisition</span>
    </h1>
  ...
  ?>
  <div class="row">
    <a href="extra_sales.php" class="btn btn-primary btn-md active float-left ml-3" role="button" aria-pressed="true">
    ...
    <form method="POST">
      <table id="sellerRequisitionSearch" class="table table-striped table-hover" style="display:block;overflow-y:scroll;text-align: center;">
        ...
        <tbody >
          ...
          <tr>
            <td >
              <input type="radio" id='selectedCustomer' onclick="selectSeller(this);" name="selectedSeller" value="
                <?php echo $id; ?>">
              </td>
              <th scope="row" id="id
                <?php echo $id; ?>">
        ...
        <br>
          <table id="productSalesSearch" class="table table-striped table-hover" style="display:block;overflow-y:scroll;text-align: center;">
            <thead class="thead-dark">
              ...
              <tbody >
                ...
                <tr>
                  ...
                  ?>
                  <td>
                    <button type="button" class="btn btn-warning addToCart" onclick="cartArray(
                      <?php echo $id; ?>)" id="
                      <?php echo $id; ?>" data_id="
                      <?php echo $id; ?>">
                      <i class="fa fa-plus" ></i>&emsp;Add Product
                    </button>
                  </td>
                  <?php
                   }else{
                  ?>
                  <td>
                    <button type="button" class="btn btn-warning addToCart" disabled onclick="cartArray(
                      <?php echo $id; ?>)" id="
                      <?php echo $id; ?>" data_id="
                      <?php echo $id; ?>">
                      <i class="fa fa-cart-plus" ></i>&emsp;Add Product
                    </button>
                  </td>
                  <?php
                    }
            ...
            <br>
              ...
              <br>
                <div class="row" id="sellerDetails"></div>
                <br>
                  <div class="row">
                    ...
                    <br>
                      <br>
                        <div class="row">
                          <button type="button" class="btn btn-success col-md-4 completeRequisition" style="margin-left: 320px">
                            <i class="fa fa-check"></i>&emsp;Complete Requisition
                          </button>
                        </div>
                        <br>
                          <!--
             <div class="row"><div class="input-group mb-5" style="margin-left: 250px;"><div class="input-group-prepend" ><span class="input-group-text" id="inputGroup-sizing-default">Customer #:</span></div><input type="text" class="form-control col-md-6" required aria-label="Default" aria-describedby="inputGroup-sizing-default" style="font-family: FontAwesome, Arial; font-style: normal;" placeholder='Search...&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&#xf002;' name="customerSearch" id="customerSearch"></div><div class="list-group" id="customer_results" style="margin-top: -5px;margin-left: 350px;"></div></div><br><div class="row"><div class="input-group mb-3" style="margin-left: 160px;"><div class="input-group-prepend" ><span class="input-group-text" id="inputGroup-sizing-default">Product:</span></div><input type="text" class="form-control col-md-6" required aria-label="Default" aria-describedby="inputGroup-sizing-default" style="font-family: FontAwesome, Arial; font-style: normal;" placeholder='Search...&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&#xf002;' name="productSearch" id="productSearch"><div class="input-group-prepend"style="margin-left: 30px;" ><span class="input-group-text" id="inputGroup-sizing-default">Quantity:</span></div><input type="number" class="form-control col-md-1" name="orderQty" id="orderQty" min="1" oninput="validity.valid||(value='');"></div><div class="list-group" id="product_results" style="margin-top: -5px;margin-left: 350px;"></div></div><br><div class="row"><button type="button" class="btn btn-success col-md-4 " style="margin-left: 320px"><i class="fa fa-cart-plus" id="addToCart"></i>&emsp;Add to Cart</button></div><br>
-->
                        </form>
