...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <h6 class="text-gray-600" style="margin-left: 500px;">Time: 
      <span id="time"></span>
    </h6>
  ...
  <div class="row">
    <div class="col-md-2">
      <a data-toggle="modal" data-target="#exampleModalScrollable" class="btn btn-success btn-md active" role="button" aria-pressed="true">
        <i class="fa fa-plus-circle"></i>&ensp;New Customer
      </a>
      <!-- Modal -->
                ...
                <table id="customersEditable" class="table table-striped table-hover paginate" style="display:block;overflow-y:scroll;text-align: center;">
                  ...
                  <tbody >
                    ...
                    <tr>
                      ...
                      <td class="editable" id="deliverer
                        <?php echo $count; ?>">
                        <?php echo $deliverer; ?>
                      </td>
                      <td class="uneditable"id="status
                        <?php echo $count; ?>">
                        <?php echo $status; ?>
                      </td>
                      <td class="editable"id="note
                        <?php echo $count; ?>">
                        <?php echo $note; ?>
                      </td>
                      <?php
                     if ($view == 'Software' || $view == 'General Operations Manager' || $view == 'CEO') {
                      ...
                      <td>&emsp;&emsp;
                        <button id="
                          <?php echo $id; ?>" data_id="
                          <?php echo $id; ?>" class="btn btn-dark btn-sm active blacklistCustomer" role="button" aria-pressed="true" >Blacklist
                        </button>
                        <button id="
                          <?php echo $id; ?>" data_id="
                          <?php echo $id; ?>" class="btn btn-danger btn-sm active deleteCustomer" role="button" aria-pressed="true" >
