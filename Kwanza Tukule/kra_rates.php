...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Dashboard 
      ...
      <span style="font-size: 12px;"> /KRA Tax Rates</span>
    </h1>
    ...
    <br>
      <div class="row">
        <div class="col-md-12 offset-3">
          <p>For more information or queries, 
            <a href="https://www.kra.go.ke/en/individual/filing-paying/types-of-taxes/paye">Visit KRA Page 
