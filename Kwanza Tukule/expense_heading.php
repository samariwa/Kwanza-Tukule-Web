<?php
 ...
 ?> 
  ...
  <div class="row">
        <a href="expenses.php" class="btn btn-primary btn-md active" role="button" aria-pressed="true" style="margin-left: 20px;"><i class="fa fa-arrow-left"></i>&ensp;Back</a>    
           <?php
        $expenseheadingrowcount = mysqli_num_rows($expenseHeadingList);
      ?>
      <h6 style="margin-left: 340px;">Total Number: <?php echo $expenseheadingrowcount ?></h6>
        <a data-toggle="modal" data-target="#exampleModalScrollable" class="btn btn-secondary btn-md active" role="button" aria-pressed="true" style="margin-left: 245px;"><i class="fa fa-plus-circle"></i>&ensp;New Expense Heading</a>
       <!-- Modal -->
