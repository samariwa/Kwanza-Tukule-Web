...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Dashboard 
      <span style="font-size: 18px;">/Expense Headings</span>
    </h1>
  ...
  <div class="row">
    <div class="col-md-4">
      <a href="expenses.php" class="btn btn-primary btn-md active" role="button" aria-pressed="true">
    ...
    <div class="col-md-4">
      ...
      <h6 class="offset-3">Total Number: 
        <?php echo $expenseheadingrowcount ?>
      </h6>
    </div>
    <div class="col-md-4">
      <a data-toggle="modal" data-target="#exampleModalScrollable" class="btn btn-secondary btn-md active offset-4" role="button" aria-pressed="true">
        <i class="fa fa-plus-circle"></i>&ensp;New Expense Heading
      </a>
      <!-- Modal -->
          ...
          <tbody >
            ...
            <tr>
              ...
              <td>
                <button id="
                  <?php echo $id; ?>" data_id="
                  <?php echo $id; ?>" class="btn btn-danger btn-sm active deleteExpenseHeading" role="button" aria-pressed="true" >
