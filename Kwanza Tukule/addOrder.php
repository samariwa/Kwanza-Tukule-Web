...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Dashboard 
      ...
      <span style="font-size: 15px;">/New Order</span>
    </h1>
  ...
  ?>
  <div class="row">
    <a href="sales.php" class="btn btn-primary btn-md active float-left ml-3" role="button" aria-pressed="true">
    ...
    <form method="POST">
      <table id="customerOrderSearch" class="table table-striped table-hover" style="display:block;overflow-y:scroll;text-align: center;">
        ...
        <tbody >
          ...
          <tr>
            <td >
              <input type="radio" id='selectedCustomer' onclick="selectCustomer(this);" name="selectedCustomer" value="
                <?php echo $id; ?>">
              </td>
              <th scope="row" id="id
                <?php echo $id; ?>">
        ...
        <br>
          <table id="productOrderSearch" class="table table-striped table-hover" style="display:block;overflow-y:scroll;text-align: center;">
                ...
                <tr>
                  ...
                  <td>
                    <button type="button" class="btn btn-warning addToCart" onclick="cartArray(
                      ...
                      <?php echo $id; ?>" data_id="
                      <?php echo $id; ?>">
                      <i class="fa fa-cart-plus" ></i>&emsp;Add To Cart
                    </button>
                  </td>
                  <?php
                   }else{
            ...
            <br>
              ...
              <br>
                <div class="row" id="customerDetails"></div>
                <br>
                  <div class="row">
                    ...
                    <br>
                      <br>
                        <div class="row">
                          <button type="button" class="btn btn-success col-md-4 completeOrder" style="margin-left: 320px">
                            <i class="fa fa-check"></i>&emsp;Complete Order
                          </button>
                        </div>
                        <br>
                          <!--
