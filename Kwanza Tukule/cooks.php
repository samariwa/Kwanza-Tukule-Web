 ...
 ?> 
   ...
   <div class="row">
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="POST">
                 <div class="row">
                 <input type="text" name="name" id="name" class="form-control col-md-9" style="padding:15px;margin-left: 60px" placeholder="Cook Name...">
                  </div><br>
                  <div class="row">
                 <input type="text" name="contact" id="contact" class="form-control col-md-9" style="padding:15px;margin-left: 60px" placeholder="Cook Contact...">
                  </div>
            </div>
            <div class="modal-footer">
              <button type="submit" class="btn btn-primary" style="margin-right: 50px" id="addSupplier">Add Cook</button>
            </form>
            </div>
          </div>
        </div>
      ...
      <h6 style="margin-left: 270px;">Total Number: <?php echo $cooksrowcount; ?></h6>
        ...
        <table id="cooksEditable" class="table table-striped table-hover paginate" style="display:block;height:737px;overflow-y:scroll;">
