...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Dashboard 
      ...
      <span style="font-size: 15px;"> /Employee Sickoff</span>
    </h1>
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <a data-toggle="modal" data-target="#exampleModalScrollable" class="btn btn-success btn-md active float-left offset-7" role="button" aria-pressed="true">
        <i class="fa fa-plus-circle"></i>&ensp;Sick Off Application
      </a>
      <!-- Modal -->
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="POST">
                ...
                <br>
                  <div class="row">
                    <label for="sickoffReason" style="margin-left: 60px">Reason:</label>
                    <br>
                    </div>
              ...
              <br>
                <div class="row">
                  <h6 class="col-md-6 offset-4">Employee sick leave data for the past month</h6>
                  <br>
                  </div>
                  <div class="row">
                    <div class="col-md-8">
